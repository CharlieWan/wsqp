...
function setqq(obj,num){
	if (obj.length!=num.length){
		...
		for (var i=0; i<num.length; i++){
			obj[i].innerHTML = "<a target='_blank' href='http://wpa.qq.com/msgrd?v=3&uin="+num[i]+"&site=qq&menu=yes'><img border='0' src='../images/QQ_online.jpg' alt='' title=''/></a>";
		};
	};
};
...
function click_fn(id,id2){
	...
	obj.onclick = function(){
		Running(obj,{right:-200},function(){
			...
			Running(box,{right:3, opacity:100});					
		});
	};
